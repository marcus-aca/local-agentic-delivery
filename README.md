...
## Automation Policy Notice

Usage of this framework must comply with the active provider policies for automation, agent behavior, and acceptable use. Before running automated workflows, ensure your prompts, tasks, integrations, and outputs satisfy your provider's current policy requirements.
...
Runtime note: the orchestrator executes a fixed budget of 2 cycles per run.
